# Archive: root CLAUDE.md as of 2026-06-20 (superseded 2026-07-06)

> **Historical record — do not treat as current status.**
> This is the complete, verbatim content of the root `CLAUDE.md` as it stood from its last
> substantive update (commit `e3942ebc`, 2026-06-20) until the documentation-architecture
> migration (branch `docs/claude-code-architecture`, 2026-07-06).
>
> Why archived: 69% of this file was chronological build narrative that loaded into every
> Claude session while its forward-looking status markers (e.g. "Phase 4 — Merchant Portal:
> queued") had been overtaken by ~100 merged PRs. Current status authority is
> `docs/PROJECT-STATE.md`; durable instructions moved to the slim root `CLAUDE.md`,
> path-scoped `.claude/rules/`, and the `redeemo-dev-qa-toolkit` skill; still-open deferrals
> and decisions were routed to `docs/deferrals/open-register.md` and `docs/PROJECT-STATE.md` §6.
> The migration cross-check lives in the PR that introduced this file.
>
> Every claim below reflects the world as of 2026-06-20 at the latest. Verify against
> `origin/main` / `docs/PROJECT-STATE.md` before relying on anything here.

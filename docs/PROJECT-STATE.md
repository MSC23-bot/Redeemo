...
>
> **Freshness:** Merchant-programme lines re-verified against `origin/main` @ `a58db583` on **2026-07-05** (other programmes last verified @ `434ca4eb`, 2026-06-28). **Known lag (recorded 2026-07-06): PRs #375-#390 (staff error-surface pins, #377 PIN wire hygiene, D-BM1 #379/#381, smoke journeys #378/#382-#384, #385 security-runbook reconciliation, #386-#390 session cache-isolation wave) postdate that stamp and are not yet folded into §4.2 - evidence in git + Codex Vol-2; next Merchant re-reconciliation must absorb them.** Lines without

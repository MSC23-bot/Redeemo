...
- **⚠ WORK ITEM (v1.1) — templates exist for only 2 of 11 top-level categories.** Seeded today: **Food & Drink**, **Beauty & Wellness**. **The other 9 must be authored:** Health & Fitness · Out & About · Shopping · Home & Local Services · Travel & Hotels · Health & Medical · Family & Kids · Auto & Garage · Pet Services. For each: the eligible offer types + ready-made templates + the `minimumSaving` floor + a guidance tip, grounded in the sector research. **This is research-and-writing/content work, NOT code, and it BLOCKS the offer engine for those 9 categories** (a merchant there would have no templates to pick from). Sector nuances to honour: **Travel & Hotels** = 2-for-1 room-night (higher floor, ~£60+, the Entertainer model); **Health & Medical** = sensitive/clinical — free consultation/check or package, NOT BOGO on treatments; **Out & About / Family & Kids** = 2-for-1 entry / activity; **Auto & Garage** = free health-check / service bundle / £-off (no BOGO); **Home & Local Services** = free consultation / spend-&-save; **Shopping** = spend-&-save / gift-with-purchase; **Pet Services** = free add-on (nail trim with groom) / package.

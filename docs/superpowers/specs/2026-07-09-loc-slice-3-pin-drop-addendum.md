...
**Status:** DRAFT (design only; not owner-approved). Awaiting lead adjudication of the
items in the DECISIONS section, then owner sign-off on the owner-gated subset.

// apps/merchant-web/lib/securityHeaders.ts
//
// Self-contained security response headers for the Redeemo merchant portal.
//
// Kept deliberately separate from customer-web/lib/securityHeaders.ts: the merchant

...
// Day-2 Vouchers B2: builder field primitives, local to the decoupled day-2
// builder (NOT imported from components/onboarding/**). Styled to the design
// system tokens (cream identity, navy text, brand-rose focus).

...
export function WhatIsRedeemoSection() {
  return (
    <section className="bg-white py-24 md:py-32 px-6" aria-label="What is Redeemo">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-[1.05fr_0.95fr] gap-14 lg:gap-24 items-start">

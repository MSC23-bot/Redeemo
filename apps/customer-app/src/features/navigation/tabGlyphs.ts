...
// pattern. Canonical Material-Icons filled paths (viewBox 0 0 24 24), chosen
// because they fill crisply at 22px. Same concept as the lucide inactive icon:
//   home → Home · map → location pin · favourites → heart · savings → WALLET
//   (owner-locked, not piggy) · profile → person.

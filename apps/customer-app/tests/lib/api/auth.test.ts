...
describe('authApi', () => {
  ...
  it('register posts the expected payload', async () => {
    (api.post as jest.Mock).mockResolvedValue({ user: { id: 'u1', email: 'a@x.com', firstName: 'Ada', lastName: null, phone: '+44', emailVerified: false, phoneVerified: false }, accessToken: 'a', refreshToken: 'r' })

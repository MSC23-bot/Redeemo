...
function renderTab() {
  ...
  return render(
    <QueryClientProvider client={qc}>
      <ReviewsTab merchantId="m1" merchantName="Test Merchant" currentBranchId="b1" currentBranchName="Test Branch" myReview={null} isMultiBranch={true} currentBranchCount={4} allBranchesCount={4} />
    </QueryClientProvider>,
  )
}

...
### Phase 3C.1k — §DF Postcode/profile-location fallback v1 (AWAITING MERGE — head `e61957f` on `feature/df-postcode-profile-fallback`, code-tip `ebcf08c` + closure commit on top, PR not yet open)
